...
To see all the available functions, [check out this link](mahmudstat.github.io/clockplot/reference/index.html) if you are connected to the internet, otherwise run `getNamespaceExports("clockplot")` and then use `?function_name` to know more about it and see and run examples. 
